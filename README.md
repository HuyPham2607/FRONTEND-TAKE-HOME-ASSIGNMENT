...
- [ Completed ] Finish Question 1
- [ Completed ] Finish Question 2
- [ Completed ] Finish Question 3
- [ Completed ] Finish Question 4
- [ Completed ] Finish Question 5
- [ Completed ] Finish Question 6
- [ completed ] Run `yarn lint` with no errors
- [ Completed ] Run `yarn type-check` with no errors
